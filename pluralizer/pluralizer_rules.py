...
# Irregular rules.
#
irregular_rules: list[Tuple[str, str]] = [
    # Pronouns.
    ("I", "we"),
    ("me", "us"),
    ("he", "they"),
...
#   * Pluralization rules.
#   */
pluralization_rules: list[Tuple[str | re.Pattern[str], str]] = [
    (re.compile(r"(?i)s?$"), "s"),
    (re.compile(r"(?i)[^\u0000-\u007F]$"), "$0"),
    ...
    (re.compile(r"(?i)(alumn|syllab|vir|radi|nucle|fung|cact|stimul|termin|bacill|foc|uter|loc|strat)(?:us|i)$"), "$1i"),  # noqa: E501
    (re.compile(r"(?i)(alumn|alg|vertebr)(?:a|ae)$"), "$1ae"),
    (re.compile(r"(?i)(seraph|cherub)(?:im)?$"), "$1im"),
    (re.compile(r"(?i)(her|at|gr)o$"), "$1oes"),
    (re.compile(r"(?i)(agend|addend|millenni|dat|extrem|bacteri|desiderat|strat|candelabr|errat|ov|symposi|curricul|automat|quor)(?:a|um)$"), "$1a"),  # noqa: E501
    (re.compile(r"(?i)(apheli|hyperbat|periheli|asyndet|noumen|phenomen|criteri|organ|prolegomen|hedr|automat)(?:a|on)$"), "$1a"),  # noqa: E501
...
#   */
singularization_rules: list[Tuple[str | re.Pattern[str], str]] = [
    (re.compile(r"(?i)s$"), ""),
    (re.compile(r"(?i)(ss)$"), "$1"),
    ...
    (re.compile(r"(?i)\b(l|(?:neck|cross|hog|aun)?t|coll|faer|food|gen|goon|group|hipp|junk|vegg|(?:pork)?p|charl|calor|cut)ies$"), "$1ie"),  # noqa: E501
    ...
    (re.compile(r"(?i)(alumn|syllab|vir|radi|nucle|fung|cact|stimul|termin|bacill|foc|uter|loc|strat)(?:us|i)$"), "$1us"),  # noqa: E501
    (re.compile(r"(?i)(agend|addend|millenni|dat|extrem|bacteri|desiderat|strat|candelabr|errat|ov|symposi|curricul|quor)a$"), "$1um"),  # noqa: E501
    (re.compile(r"(?i)(apheli|hyperbat|periheli|asyndet|noumen|phenomen|criteri|organ|prolegomen|hedr|automat)a$"), "$1on"),  # noqa: E501
...
#   * Uncountable rules.
#   */
uncountable_rules: list[str | re.Pattern[str]] = [
